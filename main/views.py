...
class SubCategoryView(LoginRequiredMixin, View):
    def get(self, request, category_slug, subcategory_slug):
        ...
        min_price1 = request.GET.get('min_price1') if request.GET.get('min_price1') != "" else None
        max_price = request.GET.get('max_price') if request.GET.get('max_price') != "" else None
        max_price2 = request.GET.get('max_price2') if request.GET.get('max_price2') != "" else None
        ...
        if condition:
            if condition == 'new':
                ...
                products = products.filter(condition='old')

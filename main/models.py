...
class Review(models.Model):
    ...
    rating = models.PositiveIntegerField(validators=[MinValueValidator(1.0), MaxValueValidator(5.0)])
    product = models.ForeignKey(Product, on_delete=models.CASCADE)
...
class Discount(models.Model):
    product = models.ForeignKey(Product, on_delete=models.CASCADE)
    persentage = models.FloatField(validators=[MinValueValidator(0.0), MaxValueValidator(100.0)])
